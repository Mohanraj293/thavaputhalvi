...
const Nirvagam = ({ title }) => {
  ...
  return (
    <div className="nirvagam">
      ...
      <img src={image1} alt="nirvagam logo" />
      <p>
      ...
      <p>
        பெண்கள் இளைஞர்கள் தொழிமுனைவோர் ஆகியோரின் வளர்ச்சியில் நாட்டின் வளர்ச்சி
        உள்ளது என்பதை முன்னிறுத்தி அறக்கட்டளையானது ஐந்து முக்கிய செயல்பாடுகளை
        நோக்கி பல அமைப்புகளை உருவாக்கி பல நிகழ்ச்சிகள் நடத்தி நாளைய சமூகத்திற்கு
